...
Extensions can bundle [Agent Skills](/docs/cli/skills) to provide on-demand
...
follow the [Agent Skills structure](/docs/cli/skills#folder-structure),
...
disabled) using the [`/skills` command](/docs/cli/skills#managing-skills).
...
[event names](/docs/hooks/reference#supported-events) and values are arrays of
[hook definitions](/docs/hooks/reference#hook-definition).
